...
{
	public class DrawableUnitController : DrawableGameComponent, UnityObject
	{
		...
		public DrawableUnitController (Game game, String player, UnitData initialData) : base(game)
		{
		...
		protected void CheckMouseClick(object sender, ClickEventArgs args)
		{
			...
			if (result.HasValue && result.Value < float.MaxValue) {
				Console.WriteLine("Successful Click");
				OnMouseClick ();
			}
		}
